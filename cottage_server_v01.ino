...
void header()
{
  ...
  Serial.print(y_position[0][0]);
  Serial.print("||");
  Serial.println(y_position[1][0]);
  Serial.print(y_position[0][1]);
  Serial.print("||");
  Serial.println(y_position[1][1]);
  Serial.print(y_position[0][2]);
  Serial.print("||");
  Serial.println(y_position[1][2]);
  Serial.print(y_position[0][3]);
  Serial.print("||");
  Serial.println(y_position[1][3]);
  Serial.print(y_position[0][4]);
  Serial.print("||");
  Serial.println(y_position[1][4]);
}
void MainScreen()
{
...
void stickMove()
{
  ...
  if (value_X > 700 && stick_release_X)
  {
    ...
    if (stick_poz_x >= numofcolls-1) stick_poz_x = 0;
  ...
  if (value_X < 400 && stick_release_X)
  {
    time_X = millis();
    stick_release_X = !stick_release_X;
    if (stick_poz_x <= 0) stick_poz_x = numofcolls-1;
    else stick_poz_x = stick_poz_x - 1;
  }
  ...
  if (value_Y > 700 && stick_release_Y)
  {
    ...
    if (stick_poz_y >= numofrows-1) stick_poz_y = 0;
  ...
  if (value_Y < 400 && stick_release_Y)
  {
    time_Y = millis();
    stick_release_Y = !stick_release_Y;
    if (stick_poz_y <= 0) stick_poz_y = numofrows-1;
    else stick_poz_y = stick_poz_y - 1;
  }
